  ...
  _createClass(YoutubePlayback, {
    ...
    updateSize: {
      value: function updateSize() {
        this._ready && this.player && this.player.setSize(this.$el.width(), this.$el.height());
      }
    },
    ready: {
    ...
    pause: {
      value: function pause() {
        ...
        this._ready && this.player && this.player.pauseVideo();
      }
    },
    seek: {
    ...
    volume: {
      value: function volume(value) {
        this._ready && this.player && this.player.setVolume(value);
      }
    },
    progress: {
    ...
    isPlaying: {
      value: function isPlaying() {
        return this._ready && this.player && this._timeupdateTimer && this.player.getPlayerState() == YT.PlayerState.PLAYING;
      }
    },
    isHighDefinitionInUse: {
      value: function isHighDefinitionInUse() {
        return this._ready && this.player && !!this.player.getPlaybackQuality().match(/^hd\d+/);
      }
    },
    getDuration: {
